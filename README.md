...
> A self-contained Claude skill bundle for bug hunting and external red-team work · **83 skills** · 15 slash commands · **926 disclosed-report patterns** across 58 `hunt-*` vulnerability classes · enterprise identity + infrastructure attack matrices · engagement-folder scaffolding · Burp MCP integration · battle-tested across authorized red-team and bug-hunting engagements, plus public training platforms (DVWA, OWASP Juice Shop, Hacker101, testphp.vulnweb.com).
...
- **Hunt webapps** — 58 `hunt-*` skills curated from 926 disclosed reports: per-class detection patterns, payloads, bypass tables, and chain templates.
