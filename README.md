...
- **Hunt webapps** — 58 `hunt-*` skills curated from 907 disclosed reports: per-class detection patterns, payloads, bypass tables, and chain templates.
